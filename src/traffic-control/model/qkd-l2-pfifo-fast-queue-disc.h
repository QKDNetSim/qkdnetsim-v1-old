...
#ifndef QKD_L2_PFIFO_FAST_H
#define QKD_L2_PFIFO_FAST_H
 ...
 *
 * \note The only difference is that it contacts QKDManager to decide which 
 * priority should be surved at the moment (which packet is allowed to be 
 * processed).
 *
 */
class QKDL2PfifoFastQueueDisc : public QueueDisc {
public:
  /**
  ...
  /**
   * \brief QKDL2PfifoFastQueueDisc constructor
   *
   * Creates a queue with a depth of 1000 packets per band by default
   */
  QKDL2PfifoFastQueueDisc ();

  virtual ~QKDL2PfifoFastQueueDisc();
