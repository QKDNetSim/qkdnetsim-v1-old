 ...
 */
#ifndef QKD_L4_TRAFFIC_CONTROL_HELPER_H
#define QKD_L4_TRAFFIC_CONTROL_HELPER_H
 ...
 * layer.
 */
class QKDL4TrafficControlHelper
{
public:
  /**
   * Create a QKDL4TrafficControlHelper to make life easier when creating QueueDisc
   * objects.
   */
  ...
  /**
   * \returns a new QKDL4TrafficControlHelper with a default configuration
   *
   ...
   * attributes configured by QKDL4TrafficControlHelper::SetQueueDisc for
