...
RoutingProtocol::SetIpv4 (Ptr<Ipv4> ipv4)
{
  ...
  temp << "aodv-routing-tables_" << m_ipv4->GetObject<Node>()->GetId() << ".txt"; 
...
RoutingProtocol::SendRequest (Ipv4Address dst)
{
  ...
  for (std::map<Ptr<Socket>, Ipv4InterfaceAddress>::const_iterator j =
         m_socketAddresses.begin (); j != m_socketAddresses.end (); ++j)
    {
      ...
      qkdCommandTag.SetRoutingProtocolNumber(AODV_RREQ_HEADER_PROTOCOL_NUMBER);
...
RoutingProtocol::RecvAodv (Ptr<Socket> socket)
{
  ...
  this->PrintRoutingTable (routingStream, "RecvAodv");
}
...
RoutingProtocol::SendReply (RreqHeader const & rreqHeader, RoutingTableEntry const & toOrigin)
{
  ...
  packet->RemovePacketTag(qkdCommandTag);
  qkdCommandTag.SetCommand ('R');
  qkdCommandTag.SetRoutingProtocolNumber(AODV_RREP_HEADER_PROTOCOL_NUMBER);
  packet->AddPacketTag (qkdCommandTag);
  /////////////////////////////////////////////////////////////////////////////
...
RoutingProtocol::SendReplyAck (Ipv4Address neighbor)
{
  ...
  packet->RemovePacketTag(qkdCommandTag);
  qkdCommandTag.SetCommand ('R');
  qkdCommandTag.SetRoutingProtocolNumber(AODV_RREP_ACK_HEADER_PROTOCOL_NUMBER);
  packet->AddPacketTag (qkdCommandTag);
  /////////////////////////////////////////////////////////////////////////////
      ...
      if (!rerrHeader.AddUnDestination (i->first, i->second))
        {
          ...
          packet->RemovePacketTag(qkdCommandTag);
          qkdCommandTag.SetCommand ('R');
          qkdCommandTag.SetRoutingProtocolNumber(AODV_RERR_HEADER_PROTOCOL_NUMBER);
          packet->AddPacketTag (qkdCommandTag);
          /////////////////////////////////////////////////////////////////////////////
