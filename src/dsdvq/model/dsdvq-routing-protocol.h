...
#ifndef DSDVQ_ROUTING_PROTOCOL_H
#define DSDVQ_ROUTING_PROTOCOL_H
...
public:
  static TypeId
  GetTypeId (void);
  static const uint32_t DSDVQ_PORT;
...
private:
  ...
  // Receive dsdvq control packets
  /// Receive and process dsdvq control packet
  void
  RecvDsdvq (Ptr<Socket> socket);
  ...
  uint32_t 
  FindLocalInterfaceForDestination(Ipv4Address dst);
...
#endif /* DSDVQ_ROUTING_PROTOCOL_H */
