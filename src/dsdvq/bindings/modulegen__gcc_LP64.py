...
def module_init():
    root_module = Module('ns.dsdvq', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## dsdvq-helper.h (module 'dsdvq'): ns3::DsdvqHelper [class]
    module.add_class('DsdvqHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace dsdvq
    
    nested_module = module.add_cpp_namespace('dsdvq')
    register_types_ns3_dsdvq(nested_module)
...
def register_types_ns3_dsdvq(module):
    root_module = module.get_root()
    
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID'])
    ## dsdvq-packet.h (module 'dsdvq'): ns3::dsdvq::DsdvqHeader [class]
    module.add_class('DsdvqHeader', parent=root_module['ns3::Header'])
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::PacketQueue [class]
    module.add_class('PacketQueue')
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::QueueEntry [class]
    module.add_class('QueueEntry')
    ## dsdvq-routing-protocol.h (module 'dsdvq'): ns3::dsdvq::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTable [class]
    module.add_class('RoutingTable')
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    module.add_container('std::map< ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry >', ('ns3::Ipv4Address', 'ns3::dsdvq::RoutingTableEntry'), container_type=u'map')
...
def register_methods(root_module):
    ...
    register_Ns3DsdvqHelper_methods(root_module, root_module['ns3::DsdvqHelper'])
    ...
    register_Ns3DsdvqDsdvqHeader_methods(root_module, root_module['ns3::dsdvq::DsdvqHeader'])
    register_Ns3DsdvqPacketQueue_methods(root_module, root_module['ns3::dsdvq::PacketQueue'])
    register_Ns3DsdvqQueueEntry_methods(root_module, root_module['ns3::dsdvq::QueueEntry'])
    register_Ns3DsdvqRoutingProtocol_methods(root_module, root_module['ns3::dsdvq::RoutingProtocol'])
    register_Ns3DsdvqRoutingTable_methods(root_module, root_module['ns3::dsdvq::RoutingTable'])
    register_Ns3DsdvqRoutingTableEntry_methods(root_module, root_module['ns3::dsdvq::RoutingTableEntry'])
    return
...
def register_Ns3DsdvqHelper_methods(root_module, cls):
    ## dsdvq-helper.h (module 'dsdvq'): ns3::DsdvqHelper::DsdvqHelper(ns3::DsdvqHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::DsdvqHelper const &', 'arg0')])
    ## dsdvq-helper.h (module 'dsdvq'): ns3::DsdvqHelper::DsdvqHelper() [constructor]
    cls.add_constructor([])
    ## dsdvq-helper.h (module 'dsdvq'): ns3::DsdvqHelper * ns3::DsdvqHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::DsdvqHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dsdvq-helper.h (module 'dsdvq'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::DsdvqHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## dsdvq-helper.h (module 'dsdvq'): void ns3::DsdvqHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3DsdvqDsdvqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## dsdvq-packet.h (module 'dsdvq'): ns3::dsdvq::DsdvqHeader::DsdvqHeader(ns3::dsdvq::DsdvqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::DsdvqHeader const &', 'arg0')])
    ## dsdvq-packet.h (module 'dsdvq'): ns3::dsdvq::DsdvqHeader::DsdvqHeader(ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t hopcount=0, uint32_t dstSeqNo=0) [constructor]
    ...
    ## dsdvq-packet.h (module 'dsdvq'): uint32_t ns3::dsdvq::DsdvqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## dsdvq-packet.h (module 'dsdvq'): ns3::Ipv4Address ns3::dsdvq::DsdvqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dsdvq-packet.h (module 'dsdvq'): uint32_t ns3::dsdvq::DsdvqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-packet.h (module 'dsdvq'): uint32_t ns3::dsdvq::DsdvqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-packet.h (module 'dsdvq'): ns3::TypeId ns3::dsdvq::DsdvqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dsdvq-packet.h (module 'dsdvq'): uint32_t ns3::dsdvq::DsdvqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## dsdvq-packet.h (module 'dsdvq'): static ns3::TypeId ns3::dsdvq::DsdvqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dsdvq-packet.h (module 'dsdvq'): void ns3::dsdvq::DsdvqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## dsdvq-packet.h (module 'dsdvq'): void ns3::dsdvq::DsdvqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## dsdvq-packet.h (module 'dsdvq'): void ns3::dsdvq::DsdvqHeader::SetDst(ns3::Ipv4Address destination) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'destination')])
    ## dsdvq-packet.h (module 'dsdvq'): void ns3::dsdvq::DsdvqHeader::SetDstSeqno(uint32_t sequenceNumber) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## dsdvq-packet.h (module 'dsdvq'): void ns3::dsdvq::DsdvqHeader::SetHopCount(uint32_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    return

def register_Ns3DsdvqPacketQueue_methods(root_module, cls):
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::PacketQueue::PacketQueue(ns3::dsdvq::PacketQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::PacketQueue const &', 'arg0')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::PacketQueue::PacketQueue() [constructor]
    cls.add_constructor([])
    ## dsdvq-packet-queue.h (module 'dsdvq'): bool ns3::dsdvq::PacketQueue::Dequeue(ns3::Ipv4Address dst, ns3::dsdvq::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dsdvq::QueueEntry &', 'entry')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::PacketQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): bool ns3::dsdvq::PacketQueue::Enqueue(ns3::dsdvq::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::dsdvq::QueueEntry &', 'entry')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): bool ns3::dsdvq::PacketQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): uint32_t ns3::dsdvq::PacketQueue::GetCountForPacketsWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('GetCountForPacketsWithDst', 
                   'uint32_t', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): uint32_t ns3::dsdvq::PacketQueue::GetMaxPacketsPerDst() const [member function]
    cls.add_method('GetMaxPacketsPerDst', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): uint32_t ns3::dsdvq::PacketQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::Time ns3::dsdvq::PacketQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): uint32_t ns3::dsdvq::PacketQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::PacketQueue::SetMaxPacketsPerDst(uint32_t len) [member function]
    cls.add_method('SetMaxPacketsPerDst', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::PacketQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::PacketQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3DsdvqQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::QueueEntry::QueueEntry(ns3::dsdvq::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::QueueEntry const &', 'arg0')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::dsdvq::QueueEntry::UnicastForwardCallback ucb=::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::dsdvq::QueueEntry::ErrorCallback ecb=::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::dsdvq::QueueEntry::UnicastForwardCallback', 'ucb', default_value='::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::dsdvq::QueueEntry::ErrorCallback', 'ecb', default_value='::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::QueueEntry::ErrorCallback ns3::dsdvq::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::dsdvq::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::Time ns3::dsdvq::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::Ipv4Header ns3::dsdvq::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::Ptr<const ns3::Packet> ns3::dsdvq::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): ns3::dsdvq::QueueEntry::UnicastForwardCallback ns3::dsdvq::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::dsdvq::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::QueueEntry::SetErrorCallback(ns3::dsdvq::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## dsdvq-packet-queue.h (module 'dsdvq'): void ns3::dsdvq::QueueEntry::SetUnicastForwardCallback(ns3::dsdvq::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3DsdvqRoutingProtocol_methods(root_module, cls):
    ## dsdvq-routing-protocol.h (module 'dsdvq'): ns3::dsdvq::RoutingProtocol::RoutingProtocol(ns3::dsdvq::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::RoutingProtocol const &', 'arg0')])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): ns3::dsdvq::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): int64_t ns3::dsdvq::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): bool ns3::dsdvq::RoutingProtocol::GetEnableBufferFlag() const [member function]
    cls.add_method('GetEnableBufferFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): bool ns3::dsdvq::RoutingProtocol::GetEnableRAFlag() const [member function]
    cls.add_method('GetEnableRAFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): static ns3::TypeId ns3::dsdvq::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): bool ns3::dsdvq::RoutingProtocol::GetWSTFlag() const [member function]
    cls.add_method('GetWSTFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): bool ns3::dsdvq::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): ns3::Ptr<ns3::Ipv4Route> ns3::dsdvq::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::SetEnableBufferFlag(bool f) [member function]
    cls.add_method('SetEnableBufferFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::SetEnableRAFlag(bool f) [member function]
    cls.add_method('SetEnableRAFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## dsdvq-routing-protocol.h (module 'dsdvq'): void ns3::dsdvq::RoutingProtocol::SetWSTFlag(bool f) [member function]
    cls.add_method('SetWSTFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## dsdvq-routing-protocol.h (module 'dsdvq'): ns3::dsdvq::RoutingProtocol::DSDVQ_PORT [variable]
    cls.add_static_attribute('DSDVQ_PORT', 'uint32_t const', is_const=True)
    return

def register_Ns3DsdvqRoutingTable_methods(root_module, cls):
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTable::RoutingTable(ns3::dsdvq::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::RoutingTable const &', 'arg0')])
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTable::RoutingTable() [constructor]
    cls.add_constructor([])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::AddIpv4Event(ns3::Ipv4Address address, ns3::EventId id) [member function]
    cls.add_method('AddIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address'), param('ns3::EventId', 'id')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::AddRoute(ns3::dsdvq::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::dsdvq::RoutingTableEntry &', 'r')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::AnyRunningEvent(ns3::Ipv4Address address) [member function]
    cls.add_method('AnyRunningEvent', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::DeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('DeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::ForceDeleteIpv4Event(ns3::Ipv4Address address) [member function]
    cls.add_method('ForceDeleteIpv4Event', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'address')])
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::EventId ns3::dsdvq::RoutingTable::GetEventId(ns3::Ipv4Address address) [member function]
    cls.add_method('GetEventId', 
                   'ns3::EventId', 
                   [param('ns3::Ipv4Address', 'address')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::GetListOfAllRoutes(std::map<ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry> > > & allRoutes) [member function]
    cls.add_method('GetListOfAllRoutes', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry > &', 'allRoutes')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nxtHp, std::map<ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry> > > & dstList) [member function]
    cls.add_method('GetListOfDestinationWithNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nxtHp'), param('std::map< ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry > &', 'dstList')])
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Time ns3::dsdvq::RoutingTable::Getholddowntime() const [member function]
    cls.add_method('Getholddowntime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::dsdvq::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::dsdvq::RoutingTableEntry &', 'rt')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::LookupRoute(ns3::Ipv4Address id, ns3::dsdvq::RoutingTableEntry & rt, bool forRouteInput) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id'), param('ns3::dsdvq::RoutingTableEntry &', 'rt'), param('bool', 'forRouteInput')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::Purge(std::map<ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry> > > & removedAddresses) [member function]
    cls.add_method('Purge', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, ns3::dsdvq::RoutingTableEntry > &', 'removedAddresses')])
    ## dsdvq-rtable.h (module 'dsdvq'): uint32_t ns3::dsdvq::RoutingTable::RoutingTableSize() [member function]
    cls.add_method('RoutingTableSize', 
                   'uint32_t', 
                   [])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTable::Setholddowntime(ns3::Time t) [member function]
    cls.add_method('Setholddowntime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTable::Update(ns3::dsdvq::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::dsdvq::RoutingTableEntry &', 'rt')])
    return

def register_Ns3DsdvqRoutingTableEntry_methods(root_module, cls):
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTableEntry::RoutingTableEntry(ns3::dsdvq::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::dsdvq::RoutingTableEntry const &', 'arg0')])
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint32_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now(), ns3::Time SettlingTime=ns3::Simulator::Now(), bool changedEntries=false) [constructor]
    ...
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Ipv4Address ns3::dsdvq::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): bool ns3::dsdvq::RoutingTableEntry::GetEntriesChanged() const [member function]
    cls.add_method('GetEntriesChanged', 
                   'bool', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::dsdvq::RouteFlags ns3::dsdvq::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::dsdvq::RouteFlags', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): uint32_t ns3::dsdvq::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Ipv4InterfaceAddress ns3::dsdvq::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Time ns3::dsdvq::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Ipv4Address ns3::dsdvq::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Ptr<ns3::NetDevice> ns3::dsdvq::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Ptr<ns3::Ipv4Route> ns3::dsdvq::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): uint32_t ns3::dsdvq::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): ns3::Time ns3::dsdvq::RoutingTableEntry::GetSettlingTime() const [member function]
    cls.add_method('GetSettlingTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetEntriesChanged(bool entriesChanged) [member function]
    cls.add_method('SetEntriesChanged', 
                   'void', 
                   [param('bool', 'entriesChanged')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetFlag(ns3::dsdvq::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::dsdvq::RouteFlags', 'flag')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetHop(uint32_t hopCount) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint32_t', 'hopCount')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetLifeTime(ns3::Time lifeTime) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lifeTime')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> device) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'device')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> route) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'route')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetSeqNo(uint32_t sequenceNumber) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sequenceNumber')])
    ## dsdvq-rtable.h (module 'dsdvq'): void ns3::dsdvq::RoutingTableEntry::SetSettlingTime(ns3::Time settlingTime) [member function]
...
def register_functions(root_module):
    ...
    register_functions_ns3_dsdvq(module.get_submodule('dsdvq'), root_module)
    return
...
def register_functions_ns3_dsdvq(module, root_module):
    return
