 ...
 * after Raj Bhattacharjea <raj.b@gatech.edu>
 */

#ifndef VIRTUAL_TCP_L4_PROTOCOL_H
#define VIRTUAL_TCP_L4_PROTOCOL_H
 ...
 * \defgroup tcp TCP 
 *
 * This is an implementation of various Overlay (virtual) Transmission Control Protocol flavors.
 *
...
class VirtualTcpL4Protocol : public IpL4Protocol {
public:
  /**
  ...
  VirtualTcpL4Protocol ();
  virtual ~VirtualTcpL4Protocol ();
   ...
   */
  void AddSocket (Ptr<VirtualTcpSocketBase> socket);
   ...
   */
  bool RemoveSocket (Ptr<VirtualTcpSocketBase> socket);
...
protected:
   ...
   * packet. So VirtualTcpL4Protocol do not know to who the packet should be
...
private:
  ...
  std::vector<Ptr<VirtualTcpSocketBase> > m_sockets;      //!< list of sockets
   ...
   */
  VirtualTcpL4Protocol (const VirtualTcpL4Protocol &);
  /**
   * \brief Copy constructor
   *
   * Defined and not implemented to avoid misuse
   * \returns
   */
  VirtualTcpL4Protocol &operator = (const VirtualTcpL4Protocol &);
