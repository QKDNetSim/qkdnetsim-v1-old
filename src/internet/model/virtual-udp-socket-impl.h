 ...
 */
#ifndef VIRTUAL_UDP_SOCKET_IMPL_H
#define VIRTUAL_UDP_SOCKET_IMPL_H
 ...
 * \ingroup udp
 *
 * \brief A sockets interface to Overlay (virtual) UDP
 * 
...
class VirtualUdpSocketImpl : public UdpSocket
{
public:
  /**
...
#endif /* VIRTUAL_UDP_SOCKET_IMPL_H */
