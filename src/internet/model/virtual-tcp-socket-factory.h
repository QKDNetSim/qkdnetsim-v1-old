 ...
 */
#ifndef VIRTUAL_TCP_SOCKET_FACTORY_H
#define VIRTUAL_TCP_SOCKET_FACTORY_H
 ...
 * \ingroup tcp
 *
 * \brief API to create Overlay (virtual) TCP socket instances 
 *
 ...
 * 
 * \see VirtualTcpSocketFactory
 *
 */
class VirtualTcpSocketFactory : public SocketFactory
{
public:
  /**
   * Get the type ID.
...
#endif /* VIRTUAL_TCP_SOCKET_FACTORY_H */
