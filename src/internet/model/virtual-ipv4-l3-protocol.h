...
#ifndef VIRTUAL_IPV4_L3_PROTOCOL_H
#define VIRTUAL_IPV4_L3_PROTOCOL_H
...
class VirtualIpv4L3ProtocolTestCase;
 ...
 * \ingroup ipv4
 *
 * \brief Implement the IPv4 Overlay (virtual) layer.
 * 
 ...
 * attack.
 */
class VirtualIpv4L3Protocol : public Ipv4
{
public:
  /**
  ...
  VirtualIpv4L3Protocol();
  virtual ~VirtualIpv4L3Protocol ();
...
private:
  friend class ::VirtualIpv4L3ProtocolTestCase;
   ...
   */
  VirtualIpv4L3Protocol(const VirtualIpv4L3Protocol &);
   ...
   */
  VirtualIpv4L3Protocol &operator = (const VirtualIpv4L3Protocol &);
...
#endif /* VIRTUAL_IPV4_L3_PROTOCOL_H */
