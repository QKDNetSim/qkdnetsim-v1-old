...
NS_LOG_COMPONENT_DEFINE ("VirtualIpv4L3Protocol");

const uint16_t VirtualIpv4L3Protocol::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (VirtualIpv4L3Protocol);

TypeId 
VirtualIpv4L3Protocol::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::VirtualIpv4L3Protocol")
    .SetParent<Ipv4> ()
    .SetGroupName ("Internet")
    .AddConstructor<VirtualIpv4L3Protocol> ()
    .AddAttribute ("DefaultTtl",
                   "The TTL value set by default on "
                   "all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&VirtualIpv4L3Protocol::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments "
                   "will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&VirtualIpv4L3Protocol::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddTraceSource ("Tx",
                     "Send ipv4 packet to outgoing interface.",
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_txTrace),
                     "ns3::VirtualIpv4L3Protocol::TxRxTracedCallback")
    .AddTraceSource ("Rx",
                     "Receive ipv4 packet from incoming interface.",
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_rxTrace),
                     "ns3::VirtualIpv4L3Protocol::TxRxTracedCallback")
    .AddTraceSource ("Drop",
                     "Drop ipv4 packet",
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_dropTrace),
                     "ns3::VirtualIpv4L3Protocol::DropTracedCallback")
    .AddAttribute ("InterfaceList",
                   "The set of Ipv4 interfaces associated to this Ipv4 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&VirtualIpv4L3Protocol::m_interfaces),
    ...
    .AddTraceSource ("SendOutgoing",
                     ...
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_sendOutgoingTrace),
                     "ns3::VirtualIpv4L3Protocol::SentTracedCallback")
    .AddTraceSource ("UnicastForward",
                     "A unicast IPv4 packet was received by this node "
                     "and is being forwarded to another node",
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_unicastForwardTrace),
                     "ns3::VirtualIpv4L3Protocol::SentTracedCallback")
    .AddTraceSource ("LocalDeliver",
                     "An IPv4 packet was received by/for this node, "
                     "and it is being forward up the stack",
                     MakeTraceSourceAccessor (&VirtualIpv4L3Protocol::m_localDeliverTrace),
                     "ns3::VirtualIpv4L3Protocol::SentTracedCallback")
...
VirtualIpv4L3Protocol::VirtualIpv4L3Protocol()
{
...
void
VirtualIpv4L3Protocol::Insert (Ptr<IpL4Protocol> protocol)
{
...
void
VirtualIpv4L3Protocol::Insert (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
...
void
VirtualIpv4L3Protocol::Remove (Ptr<IpL4Protocol> protocol)
{
  NS_LOG_FUNCTION (this << protocol);
...
void
VirtualIpv4L3Protocol::Remove (Ptr<IpL4Protocol> protocol, uint32_t interfaceIndex)
{
  NS_LOG_FUNCTION (this << protocol << interfaceIndex);
...
Ptr<IpL4Protocol>
VirtualIpv4L3Protocol::GetProtocol (int protocolNumber) const
{
...
Ptr<IpL4Protocol>
VirtualIpv4L3Protocol::GetProtocol (int protocolNumber, int32_t interfaceIndex) const
{
...
void
VirtualIpv4L3Protocol::SetNode (Ptr<Node> node)
{
...
Ptr<Socket> 
VirtualIpv4L3Protocol::CreateRawSocket (void)
{
  NS_LOG_FUNCTION (this);
...
void 
VirtualIpv4L3Protocol::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
VirtualIpv4L3Protocol::NotifyNewAggregate ()
{
  NS_LOG_FUNCTION (this);
  if (m_node == 0)
    {
...
void 
VirtualIpv4L3Protocol::SetRoutingProtocol (Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
VirtualIpv4L3Protocol::GetRoutingProtocol (void) const
{
  NS_LOG_FUNCTION (this);
...
void 
VirtualIpv4L3Protocol::DoDispose (void)
{
  NS_LOG_FUNCTION (this);
...
void
VirtualIpv4L3Protocol::SetupLoopback (void)
{
  NS_LOG_FUNCTION (this);
  ...
  node->RegisterProtocolHandler (MakeCallback (&VirtualIpv4L3Protocol::Receive, this), 
                                 VirtualIpv4L3Protocol::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
VirtualIpv4L3Protocol::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
VirtualIpv4L3Protocol::AddInterface (Ptr<NetDevice> device)
{
  ...
  tc->RegisterProtocolHandler (MakeCallback (&VirtualIpv4L3Protocol::Receive, this),
                               VirtualIpv4L3Protocol::PROT_NUMBER, device);
...
uint32_t 
VirtualIpv4L3Protocol::AddIpv4Interface (Ptr<Ipv4Interface>interface)
{
...
Ptr<Ipv4Interface>
VirtualIpv4L3Protocol::GetInterface (uint32_t index) const
{
...
uint32_t 
VirtualIpv4L3Protocol::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
VirtualIpv4L3Protocol::GetInterfaceForAddress (
...
int32_t 
VirtualIpv4L3Protocol::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
VirtualIpv4L3Protocol::GetInterfaceForDevice (
...
bool
VirtualIpv4L3Protocol::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
...
void 
VirtualIpv4L3Protocol::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  ...
  */
  ...
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&VirtualIpv4L3Protocol::IpForward, this),
                                      MakeCallback (&VirtualIpv4L3Protocol::IpMulticastForward, this),
                                      MakeCallback (&VirtualIpv4L3Protocol::LocalDeliver, this),
                                      MakeCallback (&VirtualIpv4L3Protocol::RouteInputError, this)
                                      ))
    {
...
VirtualIpv4L3Protocol::GetIcmp (void) const
{
  NS_LOG_FUNCTION (this);
    return 0;
    /*
...
bool
VirtualIpv4L3Protocol::IsUnicast (Ipv4Address ad) const
{
...
bool
VirtualIpv4L3Protocol::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
VirtualIpv4L3Protocol::SendWithHeader (Ptr<Packet> packet, 
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
...
void
VirtualIpv4L3Protocol::CallTxTrace (const Ipv4Header & ipHeader, Ptr<Packet> packet,
...
void 
VirtualIpv4L3Protocol::Send (Ptr<Packet> packet, 
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
  ...
  if (destination.IsBroadcast () || destination.IsLocalMulticast ())
    {
      NS_LOG_LOGIC ("VirtualIpv4L3Protocol::Send case 1:  limited broadcast");
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("VirtualIpv4L3Protocol::Send case 2:  subnet directed bcast to " << ifAddr.GetLocal ());
              ipHeader = BuildHeader (source, destination, protocol, packet->GetSize (), ttl, tos, mayFragment);
              Ptr<Packet> packetCopy = packet->Copy ();
  ...
  if (route && route->GetGateway () != Ipv4Address ())
    {
      NS_LOG_LOGIC ("VirtualIpv4L3Protocol::Send case 3:  passed in with route");
  ...
  if (route && route->GetGateway () == Ipv4Address ())
    {
      ...
      // to be queried).
      NS_FATAL_ERROR ("VirtualIpv4L3Protocol::Send case 4: This case not yet implemented");
    }
  // 5) packet is not broadcast, and route is NULL (e.g., a raw socket call)
  NS_LOG_LOGIC ("VirtualIpv4L3Protocol::Send case 5:  passed in with no route " << destination);
  ...
  if (m_routingProtocol != 0)
    ...
    {
      NS_LOG_ERROR ("VirtualIpv4L3Protocol::Send: m_routingProtocol == 0");
    }
  if (newRoute)
    {
...
Ipv4Header
VirtualIpv4L3Protocol::BuildHeader (
  Ipv4Address source,
  Ipv4Address destination,
  uint8_t protocol,
...
void
VirtualIpv4L3Protocol::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
...
void
VirtualIpv4L3Protocol::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void
VirtualIpv4L3Protocol::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
  ...
  if (ipHeader.GetTtl () == 0)
    {
      ...
      if (ipHeader.GetProtocol () != Icmpv4L4Protocol::PROT_NUMBER && 
        ...
        {
           NS_LOG_FUNCTION (this << "!!!!!!!!! ICMP SEND TIME EXCEEDED TTL!!!!!!!!!");
...
void
VirtualIpv4L3Protocol::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
      ...
      switch (status) {
        ...
        case IpL4Protocol::RX_ENDPOINT_UNREACH:
          ...
          if (subnetDirected == false)
            {
              NS_LOG_FUNCTION (this << "!!!!!!!!! ICMP SEND DEST UNREACHED PORT !!!!!!!!!");
...
bool
VirtualIpv4L3Protocol::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
...
VirtualIpv4L3Protocol::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
...
uint32_t 
VirtualIpv4L3Protocol::GetNAddresses (uint32_t interface) const
{
  NS_LOG_FUNCTION (this << interface);
...
bool
VirtualIpv4L3Protocol::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
VirtualIpv4L3Protocol::RemoveAddress (uint32_t i, Ipv4Address address)
{
  NS_LOG_FUNCTION (this << i << address);
...
Ipv4Address
VirtualIpv4L3Protocol::SourceAddressSelection (uint32_t interfaceIdx, Ipv4Address dest)
{
...
Ipv4Address 
VirtualIpv4L3Protocol::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
VirtualIpv4L3Protocol::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
VirtualIpv4L3Protocol::GetMetric (uint32_t i) const
{
...
uint16_t 
VirtualIpv4L3Protocol::GetMtu (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
bool 
VirtualIpv4L3Protocol::IsUp (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
VirtualIpv4L3Protocol::SetUp (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
VirtualIpv4L3Protocol::SetDown (uint32_t ifaceIndex)
{
...
bool 
VirtualIpv4L3Protocol::IsForwarding (uint32_t i) const
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
void 
VirtualIpv4L3Protocol::SetForwarding (uint32_t i, bool val)
{
  NS_LOG_FUNCTION (this << i);
  Ptr<Ipv4Interface> interface = GetInterface (i);
...
Ptr<NetDevice>
VirtualIpv4L3Protocol::GetNetDevice (uint32_t i)
{
  NS_LOG_FUNCTION (this << i);
...
void 
VirtualIpv4L3Protocol::SetIpForward (bool forward) 
{
...
bool 
VirtualIpv4L3Protocol::GetIpForward (void) const
{
  NS_LOG_FUNCTION (this);
  return m_ipForward;
}
...
void 
VirtualIpv4L3Protocol::SetWeakEsModel (bool model)
{
...
bool 
VirtualIpv4L3Protocol::GetWeakEsModel (void) const
{
  NS_LOG_FUNCTION (this);
...
void
VirtualIpv4L3Protocol::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
...
void
VirtualIpv4L3Protocol::DoFragmentation (Ptr<Packet> packet, const Ipv4Header & ipv4Header, uint32_t outIfaceMtu, std::list<Ipv4PayloadHeaderPair>& listFragments)
{
...
bool
VirtualIpv4L3Protocol::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
  ...
  if (it == m_fragments.end ())
    {
      ...
      m_fragmentsTimers[key] = Simulator::Schedule (m_fragmentExpirationTimeout,
                                                    &VirtualIpv4L3Protocol::HandleFragmentsTimeout, this,
                                                    key, ipHeader, iif);
    }
  else
    {
...
VirtualIpv4L3Protocol::Fragments::Fragments ()
  : m_moreFragment (0)
{
  NS_LOG_FUNCTION (this);
}
...
void
VirtualIpv4L3Protocol::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
VirtualIpv4L3Protocol::Fragments::IsEntire () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
VirtualIpv4L3Protocol::Fragments::GetPacket () const
{
  NS_LOG_FUNCTION (this);
...
Ptr<Packet>
VirtualIpv4L3Protocol::Fragments::GetPartialPacket () const
{
  NS_LOG_FUNCTION (this);
...
void
VirtualIpv4L3Protocol::HandleFragmentsTimeout (std::pair<uint64_t, uint32_t> key, Ipv4Header & ipHeader, uint32_t iif)
{
  ...
  if ( packet->GetSize () > 8 )
    {
       ...
       NS_LOG_FUNCTION (this << "!!!!!!!!! ICMP SEND HandleFragmentsTimeout!!!!!!!!!");
      //Ptr<Icmpv4L4Protocol> icmp = GetIcmp ();
      //icmp->SendTimeExceededTtl (ipHeader, packet);
    }
