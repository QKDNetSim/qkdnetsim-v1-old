 ...
 *
 * Authors: Miralem Mehic <miralem.mehic@ieee.org> after
 *          George F. Riley<riley@ece.gatech.edu>
 *          Mathieu Lacage <mathieu.lacage@sophia.inria.fr>
 */

#ifndef VIRTUAL_UDP_SOCKET_H
#define VIRTUAL_UDP_SOCKET_H
 ...
 * \ingroup udp
 *
 * \brief (abstract) base class of all Overlay (virtual) VirtualUdpSockets
 *
 * This class exists solely for hosting VirtualUdpSocket attributes that can
 * be reused across different implementations, and for declaring
 * UDP-specific multicast API.
 */
class VirtualUdpSocket : public Socket
{
public:
  /**
   * Get the type ID.
  ...
  VirtualUdpSocket (void);
  virtual ~VirtualUdpSocket (void);
