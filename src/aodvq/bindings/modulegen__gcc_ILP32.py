...
def module_init():
    root_module = Module('ns.aodvq', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## aodvq-helper.h (module 'aodvq'): ns3::AodvqHelper [class]
    module.add_class('AodvqHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace aodvq
    
    nested_module = module.add_cpp_namespace('aodvq')
    register_types_ns3_aodvq(nested_module)
...
def register_types_ns3_aodvq(module):
    root_module = module.get_root()
    
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::MessageType [enumeration]
    module.add_enum('MessageType', ['AODVQTYPE_RREQ', 'AODVQTYPE_RREP', 'AODVQTYPE_RERR', 'AODVQTYPE_RREP_ACK'])
    ## aodvq-dpd.h (module 'aodvq'): ns3::aodvq::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## aodvq-id-cache.h (module 'aodvq'): ns3::aodvq::IdCache [class]
    module.add_class('IdCache')
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors [class]
    module.add_class('Neighbors')
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::aodvq::Neighbors'])
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::QueueEntry [class]
    module.add_class('QueueEntry')
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::RequestQueue [class]
    module.add_class('RequestQueue')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::aodvq::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTable [class]
    module.add_class('RoutingTable')
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3AodvqHelper_methods(root_module, root_module['ns3::AodvqHelper'])
    ...
    register_Ns3AodvqDuplicatePacketDetection_methods(root_module, root_module['ns3::aodvq::DuplicatePacketDetection'])
    register_Ns3AodvqIdCache_methods(root_module, root_module['ns3::aodvq::IdCache'])
    register_Ns3AodvqNeighbors_methods(root_module, root_module['ns3::aodvq::Neighbors'])
    register_Ns3AodvqNeighborsNeighbor_methods(root_module, root_module['ns3::aodvq::Neighbors::Neighbor'])
    register_Ns3AodvqQueueEntry_methods(root_module, root_module['ns3::aodvq::QueueEntry'])
    register_Ns3AodvqRequestQueue_methods(root_module, root_module['ns3::aodvq::RequestQueue'])
    register_Ns3AodvqRerrHeader_methods(root_module, root_module['ns3::aodvq::RerrHeader'])
    register_Ns3AodvqRoutingProtocol_methods(root_module, root_module['ns3::aodvq::RoutingProtocol'])
    register_Ns3AodvqRoutingTable_methods(root_module, root_module['ns3::aodvq::RoutingTable'])
    register_Ns3AodvqRoutingTableEntry_methods(root_module, root_module['ns3::aodvq::RoutingTableEntry'])
    register_Ns3AodvqRrepAckHeader_methods(root_module, root_module['ns3::aodvq::RrepAckHeader'])
    register_Ns3AodvqRrepHeader_methods(root_module, root_module['ns3::aodvq::RrepHeader'])
    register_Ns3AodvqRreqHeader_methods(root_module, root_module['ns3::aodvq::RreqHeader'])
    register_Ns3AodvqTypeHeader_methods(root_module, root_module['ns3::aodvq::TypeHeader'])
    return
...
def register_Ns3AodvqHelper_methods(root_module, cls):
    ## aodvq-helper.h (module 'aodvq'): ns3::AodvqHelper::AodvqHelper(ns3::AodvqHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::AodvqHelper const &', 'arg0')])
    ## aodvq-helper.h (module 'aodvq'): ns3::AodvqHelper::AodvqHelper() [constructor]
    cls.add_constructor([])
    ## aodvq-helper.h (module 'aodvq'): int64_t ns3::AodvqHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## aodvq-helper.h (module 'aodvq'): ns3::AodvqHelper * ns3::AodvqHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::AodvqHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-helper.h (module 'aodvq'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::AodvqHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## aodvq-helper.h (module 'aodvq'): void ns3::AodvqHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3AodvqDuplicatePacketDetection_methods(root_module, cls):
    ## aodvq-dpd.h (module 'aodvq'): ns3::aodvq::DuplicatePacketDetection::DuplicatePacketDetection(ns3::aodvq::DuplicatePacketDetection const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::DuplicatePacketDetection const &', 'arg0')])
    ## aodvq-dpd.h (module 'aodvq'): ns3::aodvq::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## aodvq-dpd.h (module 'aodvq'): ns3::Time ns3::aodvq::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-dpd.h (module 'aodvq'): bool ns3::aodvq::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## aodvq-dpd.h (module 'aodvq'): void ns3::aodvq::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3AodvqIdCache_methods(root_module, cls):
    ## aodvq-id-cache.h (module 'aodvq'): ns3::aodvq::IdCache::IdCache(ns3::aodvq::IdCache const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::IdCache const &', 'arg0')])
    ## aodvq-id-cache.h (module 'aodvq'): ns3::aodvq::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## aodvq-id-cache.h (module 'aodvq'): ns3::Time ns3::aodvq::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-id-cache.h (module 'aodvq'): uint32_t ns3::aodvq::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## aodvq-id-cache.h (module 'aodvq'): bool ns3::aodvq::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## aodvq-id-cache.h (module 'aodvq'): void ns3::aodvq::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aodvq-id-cache.h (module 'aodvq'): void ns3::aodvq::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3AodvqNeighbors_methods(root_module, cls):
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbors(ns3::aodvq::Neighbors const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::Neighbors const &', 'arg0')])
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> a) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'a')])
    ## aodvq-neighbor.h (module 'aodvq'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aodvq::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aodvq-neighbor.h (module 'aodvq'): ns3::Time ns3::aodvq::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## aodvq-neighbor.h (module 'aodvq'): ns3::Callback<void, const ns3::WifiMacHeader &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::aodvq::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## aodvq-neighbor.h (module 'aodvq'): bool ns3::aodvq::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## aodvq-neighbor.h (module 'aodvq'): void ns3::aodvq::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3AodvqNeighborsNeighbor_methods(root_module, cls):
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::Neighbor(ns3::aodvq::Neighbors::Neighbor const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::Neighbors::Neighbor const &', 'arg0')])
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## aodvq-neighbor.h (module 'aodvq'): ns3::aodvq::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3AodvqQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::QueueEntry::QueueEntry(ns3::aodvq::QueueEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::QueueEntry const &', 'arg0')])
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::QueueEntry::QueueEntry(ns3::Ptr<const ns3::Packet> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::aodvq::QueueEntry::UnicastForwardCallback ucb=::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::aodvq::QueueEntry::ErrorCallback ecb=::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( ), ns3::Time exp=ns3::Simulator::Now()) [constructor]
    cls.add_constructor([param('ns3::Ptr< ns3::Packet const >', 'pa', default_value='0'), param('ns3::Ipv4Header const &', 'h', default_value='ns3::Ipv4Header()'), param('ns3::aodvq::QueueEntry::UnicastForwardCallback', 'ucb', default_value='::ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::aodvq::QueueEntry::ErrorCallback', 'ecb', default_value='::ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>( )'), param('ns3::Time', 'exp', default_value='ns3::Simulator::Now()')])
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::QueueEntry::ErrorCallback ns3::aodvq::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   'ns3::aodvq::QueueEntry::ErrorCallback', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): ns3::Time ns3::aodvq::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): ns3::Ipv4Header ns3::aodvq::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): ns3::Ptr<const ns3::Packet> ns3::aodvq::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::QueueEntry::UnicastForwardCallback ns3::aodvq::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   'ns3::aodvq::QueueEntry::UnicastForwardCallback', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::QueueEntry::SetErrorCallback(ns3::aodvq::QueueEntry::ErrorCallback ecb) [member function]
    cls.add_method('SetErrorCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::ErrorCallback', 'ecb')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::QueueEntry::SetPacket(ns3::Ptr<const ns3::Packet> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::QueueEntry::SetUnicastForwardCallback(ns3::aodvq::QueueEntry::UnicastForwardCallback ucb) [member function]
    cls.add_method('SetUnicastForwardCallback', 
                   'void', 
                   [param('ns3::Ipv4RoutingProtocol::UnicastForwardCallback', 'ucb')])
    return

def register_Ns3AodvqRequestQueue_methods(root_module, cls):
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::RequestQueue::RequestQueue(ns3::aodvq::RequestQueue const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RequestQueue const &', 'arg0')])
    ## aodvq-rqueue.h (module 'aodvq'): ns3::aodvq::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## aodvq-rqueue.h (module 'aodvq'): bool ns3::aodvq::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::aodvq::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aodvq::QueueEntry &', 'entry')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aodvq-rqueue.h (module 'aodvq'): bool ns3::aodvq::RequestQueue::Enqueue(ns3::aodvq::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::aodvq::QueueEntry &', 'entry')])
    ## aodvq-rqueue.h (module 'aodvq'): bool ns3::aodvq::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aodvq-rqueue.h (module 'aodvq'): uint32_t ns3::aodvq::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): ns3::Time ns3::aodvq::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-rqueue.h (module 'aodvq'): uint32_t ns3::aodvq::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## aodvq-rqueue.h (module 'aodvq'): void ns3::aodvq::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3AodvqRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RerrHeader::RerrHeader(ns3::aodvq::RerrHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RerrHeader const &', 'arg0')])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): uint8_t ns3::aodvq::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::TypeId ns3::aodvq::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address, unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3AodvqRoutingProtocol_methods(root_module, cls):
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::aodvq::RoutingProtocol::RoutingProtocol(ns3::aodvq::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RoutingProtocol const &', 'arg0')])
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::aodvq::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## aodvq-routing-protocol.h (module 'aodvq'): int64_t ns3::aodvq::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): bool ns3::aodvq::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): bool ns3::aodvq::RoutingProtocol::GetDestinationOnlyFlag() const [member function]
    cls.add_method('GetDestinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): bool ns3::aodvq::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): bool ns3::aodvq::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): uint32_t ns3::aodvq::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::Time ns3::aodvq::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): bool ns3::aodvq::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::Ptr<ns3::Ipv4Route> ns3::aodvq::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetDestinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDestinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aodvq-routing-protocol.h (module 'aodvq'): ns3::aodvq::RoutingProtocol::AODVQ_PORT [variable]
    cls.add_static_attribute('AODVQ_PORT', 'uint32_t const', is_const=True)
    ## aodvq-routing-protocol.h (module 'aodvq'): void ns3::aodvq::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3AodvqRoutingTable_methods(root_module, cls):
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTable::RoutingTable(ns3::aodvq::RoutingTable const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RoutingTable const &', 'arg0')])
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::AddRoute(ns3::aodvq::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::aodvq::RoutingTableEntry &', 'r')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## aodvq-rtable.h (module 'aodvq'): ns3::Time ns3::aodvq::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > & unreachable) [member function]
    ...
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<const ns3::Ipv4Address, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::aodvq::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aodvq::RoutingTableEntry &', 'rt')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::aodvq::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aodvq::RoutingTableEntry &', 'rt')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::aodvq::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::aodvq::RouteFlags', 'state')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTable::Update(ns3::aodvq::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::aodvq::RoutingTableEntry &', 'rt')])
    return

def register_Ns3AodvqRoutingTableEntry_methods(root_module, cls):
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTableEntry::RoutingTableEntry(ns3::aodvq::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RoutingTableEntry const &', 'arg0')])
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now()) [constructor]
    ...
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aodvq-rtable.h (module 'aodvq'): ns3::Time ns3::aodvq::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RouteFlags ns3::aodvq::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::aodvq::RouteFlags', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): uint16_t ns3::aodvq::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Ipv4InterfaceAddress ns3::aodvq::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Time ns3::aodvq::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Ptr<ns3::NetDevice> ns3::aodvq::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): ns3::Ptr<ns3::Ipv4Route> ns3::aodvq::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): uint8_t ns3::aodvq::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): uint32_t ns3::aodvq::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): bool ns3::aodvq::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetBlacklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBlacklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetFlag(ns3::aodvq::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::aodvq::RouteFlags', 'flag')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## aodvq-rtable.h (module 'aodvq'): void ns3::aodvq::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## aodvq-rtable.h (module 'aodvq'): ns3::aodvq::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3AodvqRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepAckHeader::RrepAckHeader(ns3::aodvq::RrepAckHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RrepAckHeader const &', 'arg0')])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::TypeId ns3::aodvq::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3AodvqRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepHeader::RrepHeader(ns3::aodvq::RrepHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RrepHeader const &', 'arg0')])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds(0)) [constructor]
    ...
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint8_t ns3::aodvq::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::TypeId ns3::aodvq::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::Time ns3::aodvq::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint8_t ns3::aodvq::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3AodvqRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RreqHeader::RreqHeader(ns3::aodvq::RreqHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::RreqHeader const &', 'arg0')])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RreqHeader::GetGratuitousRrep() const [member function]
    cls.add_method('GetGratuitousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint8_t ns3::aodvq::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::TypeId ns3::aodvq::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::Ipv4Address ns3::aodvq::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetGratuitousRrep(bool f) [member function]
    cls.add_method('SetGratuitousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3AodvqTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::TypeHeader::TypeHeader(ns3::aodvq::TypeHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::aodvq::TypeHeader const &', 'arg0')])
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::TypeHeader::TypeHeader(ns3::aodvq::MessageType t=::ns3::aodvq::MessageType::AODVQTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::aodvq::MessageType', 't', default_value='::ns3::aodvq::MessageType::AODVQTYPE_RREQ')])
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::aodvq::MessageType ns3::aodvq::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::aodvq::MessageType', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): ns3::TypeId ns3::aodvq::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): uint32_t ns3::aodvq::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): static ns3::TypeId ns3::aodvq::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## aodvq-packet.h (module 'aodvq'): bool ns3::aodvq::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## aodvq-packet.h (module 'aodvq'): void ns3::aodvq::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_aodvq(module.get_submodule('aodvq'), root_module)
    return
...
def register_functions_ns3_aodvq(module, root_module):
    return
