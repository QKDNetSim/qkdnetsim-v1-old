 ...
 */
#ifndef AODVQ_RQUEUE_H
#define AODVQ_RQUEUE_H
...
/**
 * \ingroup aodvq
 * \brief AODVQ route request queue
 *
 * Since AODVQ is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
