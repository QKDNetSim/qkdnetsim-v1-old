 ...
 * \ingroup aodvq
 *
 * \brief AODVQ loopback UDP echo test case
 */
 ...
 * \ingroup tests
 *
 * \brief AODVQ Loopback test suite
 */
class AodvqLoopbackTestSuite : public TestSuite
{
public:
  AodvqLoopbackTestSuite () : TestSuite ("routing-aodvq-loopback", SYSTEM)
  {
    SetDataDir (NS_TEST_SOURCEDIR);
    // UDP Echo loopback test case
    AddTestCase (new LoopbackTestCase (), TestCase::QUICK);
  }
} g_aodvqLoopbackTestSuite; ///< the test suite
